...
(function(global){
  ...
  // v0.16.6: reverted v0.16.5 visibility bump — original was the right
  // intensity. The post-rumble visibility issue was solved by the 500ms
  // delay (gives user time to land on dashboard), not by making the
  // animation heavier.
